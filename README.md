...
## Function
The FakeGPS requests the UTC-Time from the [WorldTime-API](worldtimeapi.org) over WiFi and Internet and generates a GPRMC-Message in the GPS-Format NMEA-0183 as required from the Clock.
